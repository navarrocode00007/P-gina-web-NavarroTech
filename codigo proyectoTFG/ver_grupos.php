...
<head>
    ...
    <link rel="stylesheet" href="assets/css/ver_usuarios.css">
...
<body id="body">
    ...
    <main>
        <h2 class="titulo">GRUPOS DE TRABAJO</h2>
                    ...
                    <tbody>
                        <?php
                            ...
                            while($proyecto = $resultado_proyectos->fetch_assoc()) {
                                ...
                                echo "<td>" . $proyecto['jefe'] . "</td>";
                                echo "<td><img src='{$proyecto['ruta']}' alt='Foto del proyecto' style='max-width: 100px; max-height: 100px;'></td>"; 
                                echo "<td>";
                                echo "<form action='php/actualizar_grupo.php' method='POST'>";
                                echo "<input type='hidden' name='id' value='" . $proyecto['id'] . "'>";
                                echo "<select name='proyecto'>";

                                $proyecto_actual = $proyecto['proyecto'];

                                foreach($grupos_array as $grupo) {
                                    $selected = ($proyecto_actual == $grupo['nombre']) ? 'selected' : '';
                                    echo "<option value='" . $grupo['nombre'] . "' $selected>" . $grupo['nombre'] . "</option>";
                                }
                                ...
                                echo "<td><a href='informacion_grupo.php?id={$proyecto['id']}' class='btn-editar'>Ver Grupo</a></td>"; // Botón de edición
                                echo "</tr>";
                            }
                        ?>
                    </tbody>
