...
<body id="body">
    ...
    <main>
        <div class="welcome-banner">
            <h1>¡Bienvenido a Navarro Tech!</h1>
            <p>Nos alegra tenerte aquí, <?php echo $nombre_completo; ?>.</p>
        </div>
        ...
        <div class="features">
            <div class="feature-card">
                ...
                <p>Crea y gestiona tu proyecto innovador que cambiará el mundo.</p>
            </div>
            <div class="feature-card">
                <i class="fas fa-users"></i>
                <h3>Colaboración en Equipo</h3>
                <p>Trabaja con tus compañeros en un entorno colaborativo y eficiente.</p>
            </div>
            <div class="feature-card">
                <i class="fas fa-cogs"></i>
                <h3>Herramientas Avanzadas</h3>
                <p>Aprovecha nuestras herramientas avanzadas de trazabilidad para maximizar tu productividad.</p>
            </div>
        </div>     
    </main>
