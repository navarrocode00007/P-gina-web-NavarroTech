...
<body id="body">
    ...
    <main>
        <div class="create-user-form">
            <h2>Crea un grupo de trabajo</h2>
            <form action="crear_grupo.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="jefe">Jefe del proyecto:</label>
                    <select id="jefe" name="jefe">
                        <option value="<?php echo $nombre_completo; ?>"><?php echo $nombre_completo; ?></option>
                    </select>
                </div>
                <div class="form-group">
                ...
                <?php 
                include("php/registro_grupos_bd.php");
                ?>
        </div>
    </main>
