...
<body id="body">
                ...
                <table>
                    ...
                    <tbody>
                        <?php
                            ...
                            $user = $_SESSION['usuario'];
                            $sql_proyectos = "SELECT * FROM usuarios_bd WHERE administrador = '" . $correo . "'";
                            $resultado_proyectos = $conexion->query($sql_proyectos);

                            $sql_grupos = "SELECT * FROM grupos_bd ";
                            ...
                            while($proyecto = $resultado_proyectos->fetch_assoc()) {
                                echo "<tr data-id='" . $proyecto['id'] . "'>"; 
                                echo "<td>" . $proyecto['nombre'] . "</td>";
                                echo "<td>" . $proyecto['usuario'] . "</td>";
                                echo "<td>" . $proyecto['rol'] . "</td>";
                                echo "<td>" . $proyecto['email'] . "</td>";
                                echo "<td>" . $proyecto['telefono'] . "</td>";
                                echo "<td>";
                                echo "<form action='php/actualizar_usuario.php' method='POST'>";
                                echo "<input type='hidden' name='id' value='" . $proyecto['id'] . "'>";
                                echo "<select name='grupo'>";

                                $grupo_actual = $proyecto['grupo'];

                                foreach($grupos_array as $grupo) {
                                    // Comprobar si el grupo actual coincide con el grupo en el bucle
                                    $selected = ($grupo_actual == $grupo['nombre']) ? 'selected' : '';
    ...
    <script src="assets/js/eliminar_usuario.js"></script>
