...
<body id="body">
    ...
    <main>
        <div class="container">
            <h2 class="titulo"> Modificar Proyecto</h2>
            <p class="nota-aclarativa">Selecciona el proyecto que desea modificar pulsando el botón 'Editar' de la derecha.</p>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        while ($proyecto = $resultado_proyectos->fetch_assoc()) {
                            ...
                            echo "<td><form action='editar_proyecto.php' method='GET'>
                                    <input type='hidden' name='id' value='{$proyecto['id']}'>
                                    <button type='submit' class='btn-editar' name='editar_proyecto'>Editar</button>
                                </form></td>";
                            echo "</tr>";
